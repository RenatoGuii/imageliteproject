...
// React.FC é um tipo que define explicitamente que o componente é uma função que aceita props e retorna elementos React.
            ...
            <div className="container mx-auto flex justify-between items-center px-4">
                ...
                <div className='flex items-center'>
                    <div className='relative'>
                        <RenderIf condition={auth.getUserSessionToken() != null}>
                            <span className='w-64 py-3 px-6 text-md'>
                                Olá, {auth.getUserSessionToken()?.name}
                            </span>
                        </RenderIf>
    ...
    return ( 
        <footer className="bg-indigo-950 text-white py-4 mt-8">
            <div className="container mx-auto text-center">
                Desenvolvido por Renato Guimarães
            </div>
        </footer>
    );
}
